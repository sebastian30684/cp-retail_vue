  ...
  <footer class="app-footer-simple">
    <div class="footer-simple-content">
      <div class="footer-simple-container">
        <div class="footer-simple-text">
          <p>&copy; {{ currentYear }} SAP Customer Experience Event Platform • Professional Tracking System</p>
        </div>
        <div class="footer-simple-links">
          <a href="#" @click.prevent="navigate('contact')">Privacy Policy</a>
          <a href="#" @click.prevent="navigate('contact')">Terms of Service</a>
          ...
          <button
            ...
            class="footer-action-btn demo-access-btn"
            title="Quick login with demo account for testing"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  props: {
    showDemoAccess: {
      type: Boolean,
      default: true // Can be controlled from App.vue
    }
  },
  emits: ['navigate', 'demo-login'],
  setup(props, { emit }) {
...
<style scoped>
/* Footer Action Buttons - Shared styles */
.footer-action-btn {
  display: inline-flex;
  align-items: center;
  gap: 0.375rem;
...
/* Demo Access Button - Dashed border variant */
.demo-access-btn {
  border-style: dashed;
...
/* Ensure footer links and buttons align properly */
.footer-simple-links {
  display: flex;
  flex-wrap: wrap;
  align-items: center;
